...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "A tool for understanding algorithm complexity through visualization with real-time code analysis and animated growth curves.",
    image: "https://ik.imagekit.io/gtnmxyt2d/khalil-portfolio/projects/big-o-visualizer.png",
    tags: ["Nextjs", "TypeScript", "Algorithms", "Visualization", "Responsive"],
    gradient: "from-indigo-500 via-purple-500 to-pink-500",
    demo: "https://big-o-visualizer.netlify.app",
    category: "Web Design",
  },
];
