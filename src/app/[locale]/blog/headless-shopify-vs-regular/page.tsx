...
const en: PageContent = {
    ...
    intro: "You've probably heard the term \"headless\" thrown around in conversations about Shopify. It sounds complicated, maybe even unnecessary. But if you're trying to understand what headless Shopify means for your business, or if it's actually better for SEO, this guide breaks it down in plain English.",
    ...
    whatIsSection: {
        ...
        regularDesc: "This is the standard setup. Shopify handles everything: your products, checkout, and the storefront your customers see. You pick a theme, tweak it a bit, and you're live. It's fast to set up and Shopify handles most of the heavy lifting. The catch? Your frontend is stuck with Shopify's theme system.",
        headlessTitle: "Headless Shopify",
        headlessDesc: "Headless Shopify means you separate the frontend from the backend. Shopify still handles your products, inventory, orders, and checkout. But your storefront is built with something like React or Next.js that pulls data from Shopify via API. You get Shopify's commerce engine with a completely custom frontend.",
    },
    regularLimitsTitle: "Where Regular Shopify",
    regularLimitsTitleItalic: "Hits a Wall",
    regularLimitsDesc: "Standard Shopify works fine until it doesn't. Here's where most growing stores run into trouble.",
    regularLimits: [
    ...
    headlessBenefitsDesc: "These aren't just theoretical benefits. They're the actual problems that headless solves.",
    headlessBenefits: [
    ...
    stayRegularFooter: "Regular Shopify isn't a compromise. For most small to mid-size stores, it's the right tool. Don't go headless because it sounds cool. Go headless because you've hit a specific wall that headless solves.",
...
const ar: PageContent = {
    ...
    intro: "ربما سمعت مصطلح \"Headless\" في نقاشات حول شوبيفاي. يبدو معقداً، وربما غير ضروري. لكن إذا كنت تحاول فهم معنى Headless Shopify لعملك، أو إذا كان أفضل لـ SEO، فهذا الدليل يوضحه بطريقة بسيطة.",
    badge1: "شرح واضح",
    badge2: "رأي صادق",
    badge3: "بدون حشو",
    whatIsSection: {
        ...
        regularDesc: "هذا هو الإعداد القياسي. Shopify يتولى كل شيء: منتجاتك والدفع والواجهة الأمامية التي يراها عملاؤك. تختار قالباً، تعدله قليلاً، وتنطلق. سريع في الإعداد وShopify تتولى معظم العمل. المشكلة؟ واجهتك الأمامية مقيدة بنظام قوالب Shopify.",
        headlessTitle: "Headless Shopify",
        headlessDesc: "يعني Headless Shopify فصل الواجهة الأمامية عن الخلفية. Shopify لا تزال تتعامل مع منتجاتك والمخزون والطلبات والدفع. لكن واجهة المتجر مبنية بتقنية مثل React أو Next.js تجلب البيانات من Shopify عبر API. تحصل على محرك التجارة من Shopify مع واجهة أمامية مخصصة بالكامل.",
    },
    regularLimitsTitle: "أين يصطدم",
    regularLimitsTitleItalic: "Shopify العادي بالحواجز",
    regularLimitsDesc: "Shopify العادي يعمل بشكل جيد حتى يتوقف. إليك أين يواجه معظم المتاجر المتنامية مشاكل حقيقية.",
    regularLimits: [
    ...
    headlessBenefitsDesc: "هذه ليست فوائد نظرية. إنها المشاكل الفعلية التي يحلها Headless.",
    headlessBenefits: [
    ...
    stayRegularFooter: "Shopify العادي ليس تنازلاً. لمعظم المتاجر الصغيرة والمتوسطة، إنه الأداة الصحيحة. لا تذهب إلى Headless لأنه يبدو رائعاً. اذهب لأنه اصطدمت بحاجز محدد يحله Headless.",
