...
export const alt = "Ecommerce Websites Tiers - Khalil AbdalMageed";
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            See what $200 vs $2000 vs $20,000 actually gets you
          </p>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            khalil.mageed.net/case-studies/ecommerce-websites-tiers
          </span>
        </div>
      </div>
    ),
