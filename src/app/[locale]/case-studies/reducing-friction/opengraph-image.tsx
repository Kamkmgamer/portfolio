...
export const alt = "Reducing Friction - Khalil AbdalMageed";
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            How I increased conversion by 40% through UX improvements
          </p>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            khalil.mageed.net/case-studies/reducing-friction
          </span>
        </div>
      </div>
    ),
