...
export const alt = "KamkmPDF Scaling - Khalil AbdalMageed";
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Scaling from 100 to 100K daily users without breaking a sweat
          </p>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            khalil.mageed.net/case-studies/kamkmpdf-scaling
          </span>
        </div>
      </div>
    ),
