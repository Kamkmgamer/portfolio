...
export const alt = "KamkmPDF Reliability - Khalil AbdalMageed";
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Ensuring 99.9% uptime for a high-traffic PDF platform
          </p>
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            khalil.mageed.net/case-studies/kamkmpdf-reliability
          </span>
        </div>
      </div>
    ),
