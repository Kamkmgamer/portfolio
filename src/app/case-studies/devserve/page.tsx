...
const techStack = [
  ...
  {
    category: "Payments",
    techs: ["Stripe API", "PayPal SDK", "Webhook Handling", "Subscription Logic"],
  },
  {
    category: "DevOps",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-text/60 leading-relaxed max-w-2xl mx-auto">
              DevServe showcases enterprise-grade development practices, delivering 
              a complete SaaS platform with the speed and quality typically reserved 
            ...
            <div className="glass-card p-8">
              ...
              <ul className="space-y-4">
                {roleItems.map((item, index) => (
                  <li key={index} className="flex items-start gap-3 text-sm text-text/60">
            ...
            <div className="glass-card p-8 border-l-2 border-l-[hsl(var(--accent-gold))]">
              ...
              <ul className="space-y-4">
                {achievements.slice(0, 4).map((achievement, index) => (
                  <li key={index} className="flex items-start gap-3 text-sm text-text/60">
                    <CheckCircle className="h-4 w-4 text-[hsl(var(--accent-gold))] mt-0.5 flex-shrink-0" />
                    {achievement}
                  </li>
                ))}
              </ul>
              ...
              >
                ...
                <div className="space-y-2">
                  {stack.techs.map((tech, idx) => (
                    <div key={idx} className="flex items-center gap-3 text-sm text-text/70">
        ...
        >
          <div className="glass-card p-8 md:p-12 border border-[hsl(var(--accent-gold))]/20">
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-display mb-2">Complete Achievements</h2>
              <p className="text-text/60">Delivering enterprise-grade quality</p>
            </div>

            <div className="grid md:grid-cols-2 gap-6">
              {achievements.map((achievement, index) => (
                <div key={index} className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[hsl(var(--accent-gold))]/10 text-[hsl(var(--accent-gold))] flex items-center justify-center text-xs font-bold mt-0.5">
                    {index + 1}
                  </span>
        ...
        >
          <div className="max-w-2xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-display mb-6">
              Ready to Build Your <span className="italic text-text/50">SaaS?</span>
            </h2>
            <p className="text-lg text-text/60 mb-10 leading-relaxed">
              DevServe demonstrates my ability to deliver enterprise-grade solutions 
              with exceptional speed and quality. Let&apos;s discuss your next project.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
