        ...
        <header className="mb-24 text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-display mb-8">
              Thoughts & <br />
              <span className="italic text-text/50">Insights</span>
            </h1>

            <p className="text-lg text-text/60 leading-relaxed max-w-2xl mx-auto mb-12">
              Articles on web development, design systems, performance
              optimization, and building products that matter.
            </p>

            <div className="flex flex-wrap justify-center gap-4">
              <Badge color="bg-green-500" label="Development" />
              <Badge color="bg-amber-500" label="Design" />
              <Badge color="bg-blue-500" label="Architecture" />
            </div>
          </motion.div>
        </header>
